...
public class TensorFlowImageListener implements OnImageAvailableListener {
  ...
  private static final String OUTPUT_NAME = "decoder_2/output";

  private static final String MODEL_FILE = "file:///android_asset/inception_v1_optimized.pb";
